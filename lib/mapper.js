...
const updateFromJson = function (path, map) {
...
const updateFromSqlite = function (path, map) {
  const newSessions = {};
...
const updateFromPostgres = function (path, map) {
...
const watchPostgres = function (path, loadMap, pollingInterval) {
...
const mapFor = function (path, pollingInterval) {
  const map = {};
  let loadMap;
  let watch;
